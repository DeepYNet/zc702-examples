...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net A_0_1 [get_bd_ports A] [get_bd_pins nand_gate_0/A]
  connect_bd_net -net B_0_1 [get_bd_ports B] [get_bd_pins nand_gate_0/B]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports LED] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net nand_gate_0_C [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins nand_gate_0/Y]
