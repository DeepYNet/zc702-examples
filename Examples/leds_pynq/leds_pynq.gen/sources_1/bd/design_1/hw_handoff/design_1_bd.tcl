...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net adder_0_C [get_bd_ports C] [get_bd_pins adder_0/C]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins adder_0/B] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins adder_0/A] [get_bd_pins axi_gpio_0/gpio_io_o]
